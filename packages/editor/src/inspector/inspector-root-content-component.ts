...
export const inspectorRootContentComponentType =
  "inspector-root-content-component" as ComponentType<InspectorRootContentComponent>;

export interface InspectorRootContentComponentOptions {
  readonly id?: string;
  readonly contentId: string;
  readonly contentRegistration: WindowContentRegistrationPort;
}

export class InspectorRootContentComponent implements Component, WindowRegisteredContent {
  readonly type = inspectorRootContentComponentType;
  readonly id: string;
  ...
  constructor(
    ...
    options: InspectorRootContentComponentOptions
  ) {
    this.actor = actor;
    this.id = options.id ?? "inspector-root-content";
