...
import type { WindowDockPreview, WindowDockTargetRegion } from "../model/window-dock-targets";
import { WindowTabDragSession } from "../model/window-tab-drag-session";
import type {
  WindowTabDragSessionEndResult,
  WindowTabDragSessionState,
  WindowTabDragSource
} from "../model/window-tab-drag-session";

export interface WindowTabDragSink {
  beginTabDrag(source: WindowTabDragSource, point: UiPoint): void;
  moveTabDrag(point: UiPoint): void;
