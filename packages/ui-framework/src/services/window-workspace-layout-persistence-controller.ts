import type { UiScheduledService } from "../ports/ui-scheduler";
...
} from "../model/window-workspace-layout-persistence";

export const DEFAULT_WINDOW_WORKSPACE_FRAME_LAYOUT_STORAGE_KEY =
  "ui-framework.windowWorkspaceFrameLayout.v1";
...
export class WindowWorkspaceFrameLayoutPersistenceController implements UiScheduledService {
  ...
  constructor(options: WindowWorkspaceFrameLayoutPersistenceControllerOptions) {
    ...
    this.#key = options.key ?? DEFAULT_WINDOW_WORKSPACE_FRAME_LAYOUT_STORAGE_KEY;
...
export function loadPersistedWindowWorkspaceFrameLayout(
  ...
  key = DEFAULT_WINDOW_WORKSPACE_FRAME_LAYOUT_STORAGE_KEY
